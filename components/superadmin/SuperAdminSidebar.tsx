...
const navItems = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/dashboard/superadmin/system-settings",
        icon: Settings,
      },
      {
        title: "Audit Logs",
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "Test Panels",
        href: "/dashboard/superadmin/panels",
        icon: Package,
      },
      {
        title: "Promo Codes",
        href: "/dashboard/superadmin/promo-codes",
        icon: Ticket,
      },
    ],
  },
      ...
      >
        ...
        <div className='mb-8'>
          ...
          <div className='flex items-center gap-2 mt-1'>
            <LockKeyhole className='h-3.5 w-3.5 text-red-500' />
                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        ...
                        isActive
                          ? "bg-red-50 dark:bg-red-950/20 text-red-600 dark:text-red-400 border-l-4 border-red-600 shadow-sm"
