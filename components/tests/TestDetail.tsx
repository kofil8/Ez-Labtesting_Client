    ...
    <div className='space-y-6 sm:space-y-8 animate-in fade-in duration-500'>
      ...
      <div className='flex items-center justify-between gap-4 flex-wrap'>
        <div className='flex items-center gap-2 text-xs sm:text-sm text-muted-foreground overflow-x-auto'>
          ...
          <span className='hidden sm:inline text-foreground font-medium truncate max-w-[200px]'>
            {test.name}
          </span>
        </div>
                ...
                {test.fastingRequired !== undefined && (
                  ...
                  >
                    ...
                    <div className='text-sm font-medium'>
                      {test.fastingRequired
                        ? `Required${
                            test.fastingHours ? ` (${test.fastingHours}h)` : ""
                          }`
                        : "Not Required"}
                    </div>
                  </div>
                        ...
                        <p className='text-base leading-relaxed font-medium'>
                          {test.fastingRequired ? (
                            <>
                              ...
                              {test.fastingHours && (
                                <span className='block mt-2 text-sm text-orange-600 dark:text-orange-400'>
                                  Please fast for {test.fastingHours} hours
                                  before your test. Only water is allowed during
                                  the fasting period.
                                </span>
                              )}
                            </>
                            ...
                            <span className='text-green-700 dark:text-green-300'>
                              No fasting required. You can eat and drink
                              normally before this test.
                            </span>
                          )}
                        </p>
                      </div>
