...
export function ChangePasswordForm({
  ...
  return (
    <div className='mx-auto max-w-3xl space-y-5'>
      {mfaEnabled ? (
        <div className='rounded-xl border border-blue-100 bg-white p-4 shadow-lg shadow-blue-100/25 dark:border-slate-800 dark:bg-slate-950 dark:shadow-black/30 sm:p-5'>
          <div className='grid gap-3 sm:grid-cols-2'>
            <div
              className={`flex items-center gap-3 rounded-lg border p-3 ${
                showMfaStep
                  ? "border-blue-200 bg-blue-50 text-blue-700 dark:border-cyan-900/70 dark:bg-cyan-950/30 dark:text-cyan-200"
                  : "border-emerald-100 bg-emerald-50 text-emerald-700 dark:border-emerald-900/70 dark:bg-emerald-950/30 dark:text-emerald-200"
              }`}
            >
              <span className='grid h-8 w-8 shrink-0 place-items-center rounded-full bg-white text-sm font-bold shadow-sm dark:bg-slate-900'>
            ...
            <div
              className={`flex items-center gap-3 rounded-lg border p-3 ${
                !showMfaStep
                  ? "border-blue-200 bg-blue-50 text-blue-700 dark:border-cyan-900/70 dark:bg-cyan-950/30 dark:text-cyan-200"
                  : "border-slate-100 bg-slate-50 text-slate-500 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-400"
              }`}
            >
              <span className='grid h-8 w-8 shrink-0 place-items-center rounded-full bg-white text-sm font-bold shadow-sm dark:bg-slate-900'>
                2
      ...
      {showMfaStep ? (
        <section className='rounded-xl border border-blue-100 bg-white p-5 shadow-lg shadow-blue-100/25 dark:border-slate-800 dark:bg-slate-950 dark:shadow-black/30 sm:p-6'>
          <div className='flex items-start gap-3'>
            <div className='grid h-11 w-11 shrink-0 place-items-center rounded-lg bg-blue-50 text-blue-600 dark:bg-cyan-950/30 dark:text-cyan-300'>
              <ShieldCheck className='h-5 w-5' />
            </div>
            <div className='min-w-0'>
              <p className='text-xs font-bold uppercase tracking-[0.16em] text-blue-600 dark:text-cyan-300'>
          ...
          <div className='mx-auto mt-5 max-w-xs space-y-3'>
            ...
            <Button
              ...
              disabled={isPending}
              className='h-11 w-full bg-blue-700 hover:bg-blue-800 dark:bg-cyan-400 dark:text-slate-950 dark:hover:bg-cyan-300'
            >
        ...
        <section className='rounded-xl border border-blue-100 bg-white p-5 shadow-lg shadow-blue-100/25 dark:border-slate-800 dark:bg-slate-950 dark:shadow-black/30 sm:p-6'>
          <div className='mb-5 flex items-start gap-3 border-b border-slate-100 pb-5 dark:border-slate-800'>
            <div className='grid h-11 w-11 shrink-0 place-items-center rounded-lg bg-slate-50 text-slate-700 dark:bg-slate-900 dark:text-slate-200'>
          ...
          {!mfaEnabled ? (
            <div className='mb-5 rounded-lg border border-amber-100 bg-amber-50 p-4 dark:border-amber-900/70 dark:bg-amber-950/30'>
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <Button asChild variant='outline' className='mt-4 bg-white dark:border-slate-700 dark:bg-slate-900 dark:hover:bg-slate-800'>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
            ...
            <Button
              ...
              className='h-11 w-full bg-blue-700 text-base font-semibold hover:bg-blue-800 dark:bg-cyan-400 dark:text-slate-950 dark:hover:bg-cyan-300'
            >
