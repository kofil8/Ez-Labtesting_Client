        ...
        {!isOpen ? (
          ...
          >
            <AnimatePresence>
              {showLauncherPopup && (
                <motion.div
                  ...
                  className='relative hidden w-[220px] rounded-[22px] border border-blue-100 bg-white/95 p-3 pr-10 text-left shadow-[0_18px_36px_rgba(37,99,235,0.12)] backdrop-blur xl:block'
                >
                  <button
                    type='button'
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className='group relative flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-500 text-white shadow-[0_18px_40px_rgba(37,99,235,0.3)] transition-shadow hover:shadow-[0_24px_44px_rgba(37,99,235,0.38)]'
