...
export function SiteHeader() {
  ...
  const restrictionBanner = showRestrictionBanner ? (
    <div className='border-b border-red-200 bg-red-50/95 text-red-950 backdrop-blur dark:border-red-900/70 dark:bg-red-950/80 dark:text-red-100'>
      <div className='container mx-auto flex items-start justify-center gap-3 px-4 py-2 text-center text-sm min-[600px]:items-center min-[600px]:px-6 lg:px-8 xl:px-10 min-[1536px]:px-12'>
        <AlertTriangle className='h-4 w-4 shrink-0 text-red-700 dark:text-red-300' />
  ...
  if (isLoginPage) {
    return (
      <>
        ...
        <header className='sticky top-0 z-50 w-full border-b border-border/80 bg-background/95 shadow-sm backdrop-blur-xl'>
          {restrictionBanner}
          <div className='container mx-auto px-4 min-[600px]:px-6 lg:px-8 xl:px-10 min-[1536px]:px-12'>
            <div className='flex h-16 items-center justify-between gap-2 min-[600px]:h-[4.5rem] min-[600px]:gap-3'>
              ...
              <div className='flex shrink-0 items-center gap-2 sm:gap-3'>
                <span className='hidden items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1.5 text-[11px] font-semibold text-emerald-800 dark:border-emerald-900/60 dark:bg-emerald-950/35 dark:text-emerald-300 sm:inline-flex'>
