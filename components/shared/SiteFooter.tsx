      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h3 className="awsmd-heading-md mb-6">
              <span className="awsmd-gradient-text">Subscribe</span>
              <span className="text-gray-900 dark:text-white"> to Our Newsletter</span>
            </h3>
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Get exclusive health tips, special offers, and the latest updates delivered to your inbox.
            </p>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="lg:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-sm text-base leading-relaxed">
              We would love to hear from you. Empowering you to take control of your health with direct-to-consumer lab testing. 
              HIPAA-secure, CLIA-certified, and trusted by thousands.
            </p>
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-3 text-sm">
              <a href="mailto:support@kevinlab.com" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
                <Mail className="h-4 w-4" />
                support@kevinlab.com
              </a>
              <a href="tel:1-800-LAB-TEST" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
            <p>
              &copy; {new Date().getFullYear()} Kevin Lab Testing. All rights reserved.
            </p>
