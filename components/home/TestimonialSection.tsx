    ...
    <section className='py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-blue-50/50 to-slate-50'>
      <div className='container mx-auto px-4 xs:px-5 sm:px-6 lg:px-8 xl:px-10'>
        ...
        <motion.div
          ...
          className='mx-auto max-w-2xl mb-12 sm:mb-16 text-center'
        >
          ...
          {testimonials.map((item, index) => {
            ...
            return (
              <motion.article
                ...
                className='group relative rounded-2xl border border-slate-100 bg-white p-6 sm:p-8 shadow-sm hover:shadow-md hover:border-slate-200 hover:-translate-y-1 transition-all duration-300 flex flex-col overflow-hidden'
              >
                {/* Highlight Badge */}
                ...
                {/* Quote */}
                <p className='mb-6 text-sm text-slate-500 leading-relaxed flex-1'>
                  "{item.text}"
                </p>
                ...
                <div className='flex items-center gap-4'>
                  <div className='flex h-10 w-10 items-center justify-center rounded-full bg-blue-50 border border-blue-100/50 flex-shrink-0'>
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.5 }}
          className='rounded-2xl border border-slate-100 bg-white p-6 sm:p-10 shadow-sm hover:shadow-md transition-shadow duration-300'
        >
          <h3 className='mb-8 text-center text-xl sm:text-2xl font-bold text-slate-900'>
              ...
              return (
                ...
                >
                  <div className='mb-3 flex justify-center'>
                    <div className='p-2.5 rounded-xl bg-blue-50 border border-blue-100/50 group-hover:bg-blue-100/50 transition-colors duration-300'>
                      <MetricIcon className='h-4 w-4 text-blue-600' />
                    </div>
                  </div>
                  <div className='mb-1.5 text-3xl sm:text-4xl font-bold text-slate-900 tracking-tight'>
                    {metric.value}
                  </div>
