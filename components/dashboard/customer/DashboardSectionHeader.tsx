...
import { DashboardPanelToggleButton } from "./DashboardPanelToggleButton";
    ...
    <section className='rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 via-white to-cyan-50 px-5 py-6 shadow-xl shadow-blue-100/25 sm:px-6 lg:px-7'>
      <div className='flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between'>
        ...
        <div className='flex shrink-0 items-center gap-2'>
          ...
          <DashboardPanelToggleButton className='h-12 w-12 rounded-xl border-blue-100 bg-white/85 text-blue-700 hover:bg-blue-50 hover:text-blue-800' />
        </div>
      </div>
    </section>
  );
