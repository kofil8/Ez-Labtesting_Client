...
export function CustomerProfileManager({ profile }: { profile: Profile }) {
  ...
  // Sync form state when profile prop updates (e.g. after router.refresh())
  useEffect(() => {
    setForm(getFormState(profile));
  }, [profile]);
      ...
      <section className='overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm'>
        ...
        <div className='grid grid-cols-1 gap-3 border-t border-slate-200 p-5 sm:grid-cols-2 xl:grid-cols-4'>
          <StatTile
            ...
            label='Account'
            value={formatLabel(
              profile.status || profile.accountInfo.verificationStatus,
            )}
          />
          <StatTile
          ...
          <StatTile
            ...
            label='Age'
            value={
              profile.healthSummary.age
                ? String(profile.healthSummary.age)
                : "Not set"
            }
          />
        </div>
          ...
          <div className='grid grid-cols-1 gap-5 xl:grid-cols-[1.2fr_0.8fr]'>
            <section className='rounded-lg border border-slate-200 bg-white p-5 shadow-sm'>
              ...
              <dl className='grid grid-cols-1 gap-x-8 md:grid-cols-2'>
                ...
                <DetailRow
                  label='Gender'
                  value={formatLabel(profile.contactInfo.gender)}
                />
                <DetailRow
                  label='Address'
            ...
            <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    updateField("gender", value === "unset" ? "" : value)
                  }
                >
            ...
            <div className='flex items-start gap-3'>
              ...
              <div className='min-w-0'>
                ...
                <p className='mt-1 text-sm text-slate-600'>
                  This permanently deletes your account profile from the
                  backend. You will be signed out after deletion.
                </p>
                <Button
                  type='button'
                  variant='outline'
