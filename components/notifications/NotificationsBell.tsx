      ...
      ? createPortal(
          <AnimatePresence>
            <motion.div
              ...
              className='fixed left-3 right-3 top-16 z-[9999] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl shadow-slate-900/20 dark:border-slate-800 dark:bg-slate-950 dark:shadow-black/50 sm:left-auto sm:w-96'
            >
                ...
                {items.length === 0 ? (
                  ...
                  items.slice(0, 20).map((notification) => (
                    <button
                      ...
                      className={`flex w-full flex-col gap-1 px-4 py-3 text-left transition-colors hover:bg-slate-50 dark:hover:bg-slate-900 ${
                        notification.isRead ? "opacity-70" : ""
                      }`}
                    >
                      <div className='flex items-center justify-between gap-3'>
                        <span className='min-w-0 truncate text-sm font-semibold text-slate-950 dark:text-slate-100'>
                          {notification.title}
                        </span>
              ...
              <div className='border-t border-slate-200 px-4 py-3 dark:border-slate-800'>
                <Link
                  ...
                  className='inline-flex w-full items-center justify-center rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700 transition-colors hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-600 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800 dark:focus-visible:ring-cyan-400'
                >
  ...
  return (
    <div ref={containerRef} className={cn("relative", className)}>
      <Button
        ...
        className='group relative h-10 w-10 shrink-0 rounded-xl border border-slate-200 bg-white text-slate-600 shadow-sm transition-colors hover:bg-slate-50 hover:text-slate-950 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-slate-50 sm:h-11 sm:w-11'
        aria-label={
