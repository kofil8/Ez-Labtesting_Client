...
export function TransactionCard({
  ...
  return (
    ...
    >
      <Card className='rounded-[24px] border-slate-200/80 bg-white/92 shadow-[0_20px_50px_-40px_rgba(15,23,42,0.35)] transition-all hover:border-slate-300 hover:shadow-[0_24px_60px_-38px_rgba(15,23,42,0.38)] dark:border-slate-800 dark:bg-slate-950 dark:shadow-black/30 dark:hover:border-slate-700'>
            ...
            <div className='flex items-start gap-4'>
              ...
              <div className='space-y-2'>
                <div className='flex flex-wrap items-center gap-2'>
                  <h3 className='text-sm font-semibold text-slate-950 dark:text-slate-100 sm:text-base'>
                ...
                <div className='flex flex-wrap items-center gap-2 text-xs text-slate-500 dark:text-slate-400'>
                  ...
                  <span className='rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 dark:border-slate-700 dark:bg-slate-900'>
                    {transaction.id}
                  </span>
                </div>
              </div>
            ...
            <div className='text-left sm:text-right'>
              <p
                className={cn(
                  ...
                  isPayment ? "text-slate-950 dark:text-slate-100" : "text-emerald-700 dark:text-emerald-300",
                )}
              >
                {isPayment ? "-" : "+"}
