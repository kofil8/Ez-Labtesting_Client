          ...
          <CardContent className='prose prose-gray max-w-none pt-6'>
            <section className='mb-8'>
              ...
              <p className='text-gray-700 mb-4'>
                At EzLabTesting ("we," "our," or "us"), we take your privacy
                seriously. This Privacy Policy explains how we collect, use,
                disclose, and safeguard your information when you use our
                website and services. We are committed to protecting your
                personal health information in compliance with HIPAA and other
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-700 mb-4'>
                We collect Protected Health Information (PHI) including:
              </p>
              <ul className='list-disc pl-6 space-y-2 text-gray-700 mb-4'>
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-700 mb-4'>
                We will share your information with other parties only with your
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-700 mb-4'>
                ...
                <a
                  href='mailto:privacy@ezlabtesting.com'
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-700 mb-4'>
                ...
                age. We do not knowingly collect information from children. If
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-700 mb-4'>
                ...
                services and comply with legal obligations. Lab test results are
                typically retained for at least 7 years in accordance with
            ...
            <section className='mb-8'>
              ...
              <div className='bg-gray-100 p-4 rounded-lg'>
                ...
                <p className='text-gray-700 mb-2'>
                  <strong>Mail:</strong> EzLabTesting Privacy Office
                  <br />
