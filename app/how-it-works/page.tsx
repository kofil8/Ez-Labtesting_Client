                  ...
                  <div className='flex-1'>
                    ...
                    <ul className='space-y-2'>
                      ...
                      <li className='flex items-start gap-2'>
                        <CheckCircle2 className='w-5 h-5 text-primary mt-0.5 flex-shrink-0' />
                        <span>
                          View detailed descriptions and preparation
                          instructions
                        </span>
                      </li>
                    </ul>
                ...
                <div className='flex flex-col md:flex-row-reverse gap-8 items-center'>
                  ...
                  <div className='flex-1'>
                    ...
                    <p className='text-lg text-muted-foreground mb-4'>
                      ...
                      online portal. Get detailed reports with clear
                      explanations and reference ranges.
                    </p>
                    <ul className='space-y-2'>
                      <li className='flex items-start gap-2'>
                        <CheckCircle2 className='w-5 h-5 text-primary mt-0.5 flex-shrink-0' />
                      ...
                      <li className='flex items-start gap-2'>
                        <CheckCircle2 className='w-5 h-5 text-primary mt-0.5 flex-shrink-0' />
                        <span>
                          Easy-to-understand reports with visual charts
                        </span>
                      </li>
                      <li className='flex items-start gap-2'>
                        <CheckCircle2 className='w-5 h-5 text-primary mt-0.5 flex-shrink-0' />
                        <span>
                          Download and share reports with your healthcare
                          provider
                        </span>
                      </li>
                    </ul>
            ...
            <div className='container mx-auto px-4 md:px-6'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto'>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className='text-muted-foreground'>
                      Certified professionals and accredited labs ensure
                      accurate results.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className='text-muted-foreground'>
                      No hidden fees. See the exact cost upfront before you
                      book.
                    </p>
                  </CardContent>
                </Card>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                  ...
                  <div className='flex gap-4'>
                    ...
                    <div>
                      ...
                      <p className='text-muted-foreground'>
                        Receive timely reminders for your appointments and
                        instant alerts when your results are ready.
                      </p>
                    </div>
                  </div>
