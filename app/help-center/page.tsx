...
import { Mail, Phone, MessageCircle, BookOpen, TestTube, CreditCard } from 'lucide-react';
  ...
  const supportCategories = [
    {
      ...
      links: [
        ...
        { label: 'Finding a Lab Center', href: '/find-lab-center' },
      ],
    },
    {
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="mt-12 bg-white rounded-lg shadow-md p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Link href="/test-preparation" className="text-blue-600 hover:underline">
