        ...
        <main className='flex-1 flex items-center justify-center p-8'>
          <div className='text-center max-w-md'>
            ...
            <p className='text-gray-600 mb-4'>
              Please add your Google Maps API key to .env.local to use this
              feature.
            </p>
            ...
            <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
              ...
              >
                ...
                <p className='text-base sm:text-lg md:text-xl text-blue-100 max-w-2xl mx-auto px-4'>
                  Locate convenient lab testing centers near you. Get
              ...
              <div className='max-w-4xl mx-auto'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6'>
                  ...
                  >
                    ...
                    <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400 text-center leading-relaxed'>
                      Compare ratings, hours, distances, and locations to find
                      the most convenient lab center for your needs.
                    </p>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    ...
                    <p className='text-xs sm:text-sm text-gray-600 dark:text-gray-400 text-center leading-relaxed'>
                      Visit the lab with your order confirmation to complete
                      your testing. Get directions with one click!
                    </p>
                  </motion.div>
                </div>
              </div>
